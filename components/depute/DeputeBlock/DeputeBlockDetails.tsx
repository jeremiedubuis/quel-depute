...
export const DeputeBlockDetails: React.FC<{ depute: Depute }> = ({ depute }) => {
    ...
    return (
        <div className={styles.details}>
            {depute.candidate ? <Link href={`/circonscriptions/${depute.candidate.circumscriptionSlug}`}><a>Est candidat: {depute.candidate.county} ({depute.candidate.circumscription})</a></Link> : 'Ne se représente pas' }
