...
export const ViewCircumscription: React.FC<{ circumscription: CircumscriptionType }> = ({
    circumscription
}) => {
    return (
        <main className={styles.view}>
            ...
            <section>
                <Title size={'big'}>Député sortant</Title>
                <DeputeBlock depute={circumscription.current} noCounty isLink />
            </section>
            <section>
